...
public class RedisService {
     ...
     * @return
     */
    public boolean llpush(String key, String value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return
     */
    public boolean llpush(String key, List<String> value) {
        try {
     ...
     * @return
     */
    public boolean llpush(String key, List<String> value, long time) {
        try {
            redisTemplate.opsForList().leftPushAll(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return
     */
    public boolean lrpush(String key, String value, long time) {
        try {
     ...
     * @return
     */
    public boolean lrpush(String key, List<String> value) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            return true;
        } catch (Exception e) {
     ...
     * @return
     */
    public boolean lrpush(String key, List<String> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return
     */
    public List<String> llist(String key, long start, long end) {
        return redisTemplate.opsForList().range(key, start, end);
    }
